                                ...
                                <template v-for="category in categories">
                                    <tr :class="!isEdit(category.id) ? '':'d-none'">
                                        ...
                                        <td class="justify-content-center">
                                            <a title="Edit" class="btn btn-sm btn-primary m-1" @click.prevent="changeEditId(category.id, category.title, category.description)" href="#"><i class="fas fa-edit"></i></a>
                                        </td>
                                        <td>
                                            <button title="Delete" @click.prevent="remove(category.id)" type="button" class="btn  btn-sm btn-danger m-1" ><i class="fas fa-trash-alt"></i></button>
                                        </td>
                                    </tr>
                                    ...
                                    <tr :class="isEdit(category.id) ? '':'d-none'">
                                        ...
                                        <td>{{ category.update }}</td>
                                        <td class="justify-content-center">
                                            <a title="Edit" class="btn  btn-sm btn-primary m-1" @click.prevent="update(category.id)" href="#"><i class="fas fa-edit"></i></a>
...
export default {
    ...
    methods:{
        ...
        store(){
            axios.post('/api/admin/blog/categories', {
                title: this.title,
        ...
        remove(id){
            axios.delete(`/api/admin/blog/categories/${id}`)
                .then(res => {
                    console.log(res);
                    this.getCategories()
                    this.$wkToast(res.data.message, {
        ...
        update(id){
            axios.patch(`/api/admin/blog/categories/${id}`, {
